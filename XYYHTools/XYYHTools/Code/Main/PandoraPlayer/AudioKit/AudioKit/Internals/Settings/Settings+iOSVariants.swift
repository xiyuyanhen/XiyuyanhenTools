    ...
    extension Settings {
        ...
        public static var audioFormat = defaultAudioFormat {
            didSet {
                do {
                    ...
                    AudioKit_Log("Could not set preferred sample rate to \(sampleRate) " + error.localizedDescription,
                          log: OSLog.settings,
                          type: .error)
                }
            }
            ...
            didSet {
                if #available(iOS 13.0, tvOS 13.0, *) {
                    do {
                        ...
                        AudioKit_Log("Could not set allow haptics to \(allowHapticsAndSystemSoundsDuringRecording)" +
        ...
        public static var ioBufferDuration: Double {
            set {
                do {
                    ...
                    AudioKit_Log("Could not set the preferred IO buffer duration to \(newValue): \(error)",
                          log: OSLog.settings,
                          type: .error)
                }
            }
        ...
        public static func setSession(category: SessionCategory,
            ...
            do {
                ...
                AudioKit_Log("Cannot set AVAudioSession Category to \(category) " +
            ...
            do {
                ...
                AudioKit_Log("Could not allow haptics: \(error)", log: OSLog.settings, type: .error)
            }
            ...
            do {
                ...
                AudioKit_Log("Cannot set Preferred IO Buffer Duration to " +
            ...
            do {
                ...
                AudioKit_Log("Cannot set AVAudioSession.setActive to true \(error)", log: OSLog.settings, type: .error)
                throw error
            }
        }
        ...
        public static func computedSessionOptions() -> AVAudioSession.CategoryOptions {
            ...
            if Settings.audioInputEnabled {
                    ...
                    if #available(iOS 10.0, *) {
                        ...
                        AudioKit_Log("Some of the specified Settings are not supported by iOS 9 and were ignored.")
                    }
