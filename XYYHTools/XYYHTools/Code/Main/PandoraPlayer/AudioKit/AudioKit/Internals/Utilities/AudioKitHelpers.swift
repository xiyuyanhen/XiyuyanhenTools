...
public protocol Occupiable {
    ...
    var isNotEmptyOfAudioKit: Bool { get }
}

// Give a default implementation of isNotEmptyOfAudioKit, so conformance only requires one implementation
extension Occupiable {
    /// Contains no elements
    public var isNotEmptyOfAudioKit: Bool {
        return !isEmpty
    }
}
