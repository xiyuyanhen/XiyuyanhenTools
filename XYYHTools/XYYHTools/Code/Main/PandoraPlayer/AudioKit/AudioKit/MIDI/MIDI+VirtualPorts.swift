...
extension MIDI {
    ...
    public func createVirtualPorts(_ uniqueID: Int32 = 2_000_000, name: String? = nil) {
        AudioKit_Log("Creating virtual input and output ports", log: OSLog.midi)
        destroyVirtualPorts()
    ...
    public func createVirtualInputPort(_ uniqueID: Int32 = 2_000_000, name: String? = nil) {
        ...
        if result == noErr {
            ...
            AudioKit_Log("Error \(result) Creating Virtual Input Port: \(virtualPortname) -- \(virtualInput)",
    ...
    public func createVirtualOutputPort(_ uniqueID: Int32 = 2_000_001, name: String? = nil) {
        ...
        if result == noErr {
            ...
            AudioKit_Log("Error \(result) Creating Virtual Output Port: \(virtualPortname) -- \(virtualOutput)",
                log: OSLog.midi, type: .error)
            CheckError(result)
        }
    }
