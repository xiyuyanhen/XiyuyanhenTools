...
class SectionIndexViewItem: UIView {
    ...
    var selectedCornerRadius: CGFloat = 0
    ...
    override func layoutSubviews() {
        ...
        if 0 < self.selectedCornerRadius {
            
            let width = bounds.width - selectedMargin
            let height = bounds.height - selectedMargin
            ...
            selectedView.layer.cornerRadius = self.selectedCornerRadius
