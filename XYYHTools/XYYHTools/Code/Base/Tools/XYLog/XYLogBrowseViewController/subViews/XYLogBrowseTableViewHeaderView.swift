//
//  XYLogBrowseTableViewHeaderView.swift
//  EStudy
//
...
@IBDesignable class XYLogBrowseTableViewHeaderView: UIView, XYViewNewByNibProtocol {
    ...
    enum BtnTagType : Int {
        ...
        case DeleteAll = 1001
        case ScrollToTop = 1002
        case ScrollToBottom = 1003
    }
    ...
    @IBOutlet weak var scrollToTopBtn: UIButton! {
        ...
        willSet {
            ...
            newValue.tag = BtnTagType.ScrollToTop.rawValue
            
            newValue.enlargeEdge(UIEdgeInsetsMakeEqual(10))
        }
    }
    ...
    @IBOutlet weak var scrollToBottomBtn: UIButton! {
        ...
        willSet {
            ...
            newValue.tag = BtnTagType.ScrollToBottom.rawValue
